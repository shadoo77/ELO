  ...
  load(url) {
    ...
    getSDK(SDK_URL, SDK_GLOBAL).then(Vimeo => {
      ...
      this.player = new Vimeo.Player(this.container, {
        ...
        playsinline: false,
        background: true, // true disables controlbar, and apparently playbackrate
        height: "300px",
        transparant: true,
      ...
      this.player.on(
        "playbackratechange",
        ({ playbackRate }) => {
          this.props.somename(playbackRate * 100);
        }
      );
    }, this.props.onError);
  }
