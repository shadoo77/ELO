...
export default class ReactPlayer extends Component {
  ...
  render() {
    ...
    const renderedActivePlayer = this.renderActivePlayer(
      url,
      activePlayer
    );
    ...
    const players = [renderedActivePlayer].sort(
      this.sortPlayers
    );
